...
public class Sequences {
    ...
    public static final String QA_SPECIALIST_ID_SEQ = "qa_specialist_id_seq";
    public static final String SET_CASE_ID_SEQ = "set_case_id_seq";
    public static final String SET_RUN_ID_SEQ = "set_run_id_seq";
